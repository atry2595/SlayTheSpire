...
TheSsssserpent::TheSsssserpent(game_action& actions, ironclad* player) {
    manager.unknown_ID = unknownID::the_ssssserpent;
    ...
    manager.nodes[rootIdx].next_nodes = {agreeIdx, disagreeIdx};
