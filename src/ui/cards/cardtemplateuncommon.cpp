...
CardTemplateUncommon::CardTemplateUncommon(combatEvent* eve, abstractCard* source, QPointF pos, QSizeF size, qreal z_value)
    :abstractCardTemplate(eve, source, pos, size, z_value)
{
    ...
    card_frame->setPixmap(mng.getCardFrame(cardTemplates::ancient, source->get_card_type()));
